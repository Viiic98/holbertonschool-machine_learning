...
class Yolo:
    ...
    def predict(self, folder_path):
        """ Predict images and preprocess the outputs
        ...
        pre_images, org_dim = self.preprocess_images(images)
        inputs = []
        ...
        for i in range(len(images)):
            ...
            boxes, box_conf, box_cl_pr = self.process_outputs(outputs,
                                                              org_dim[i])
            boxes, box_cl, box_sc = self.filter_boxes(boxes,
                                                      box_conf,
                                                      box_cl_pr)
            boxes, box_cl, box_sc = self.non_max_suppression(boxes,
                                                             box_cl,
                                                             box_sc)
            self.show_boxes(images[i], boxes,
                            box_cl, box_sc,
                            file_names[i])
            pred.append((boxes, box_cl, box_sc))
